              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="w-full md:w-2/3">
                  ...
                  <p className="text-gray-700 mb-4">
                    En Recomenzar, creemos que toda persona merece una segunda
                    oportunidad. Cuando la sociedad los rechaza, nosotros
                    queremos tenderles la mano, porque sabemos que con el
                    acompañamiento adecuado, es posible cambiar de vida.
                  </p>
                  <p className="text-gray-700 mb-6">
                    El nombre "Recomenzar" refleja la esencia del proceso que
                    viven las personas que luchan contra las adicciones: una
                    oportunidad para volver a empezar, dejar atrás el dolor y
                    construir una nueva vida con dignidad, apoyo y propósito.
                  </p>
                  
                  <div className="mt-6 border-t pt-6 border-green-100">
                    <div className="mb-4">
