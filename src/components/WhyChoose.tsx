              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="w-full md:w-2/3">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-gray-700">
                      Acompañar y apoyar a las personas con drogodependencias en
                      su proceso de recuperación integral, promoviendo su
                      bienestar físico, emocional y social. Trabajamos para
                      restaurar su dignidad, autonomía y derechos con un enfoque
                      centrado en la persona, el respeto y la inclusión.
                    </p>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-gray-700">
                      Ser una organización referente en la atención de personas
                      con adicciones, construyendo una sociedad más humana,
                      solidaria y libre de estigmas.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 text-gray-700">
                      <li className="flex items-center">
                        <span className="text-amber-500 mr-2">•</span> Respeto:
                        Aceptamos a cada persona tal como es, sin prejuicios.
                      </li>
                      <li className="flex items-center">
                        <span className="text-amber-500 mr-2">•</span> Empatía:
                        Escuchamos y acompañamos desde la comprensión.
                      </li>
                      <li className="flex items-center">
                        <span className="text-amber-500 mr-2">•</span>{" "}
                        Inclusión: Apostamos por una sociedad donde nadie quede
                        fuera.
                      </li>
                      <li className="flex items-center">
                        <span className="text-amber-500 mr-2">•</span>{" "}
                        Compromiso: Trabajamos con entrega y responsabilidad.
                      </li>
                      <li className="flex items-center">
                        <span className="text-amber-500 mr-2">•</span> Justicia
                        social: Defendemos los derechos de los más vulnerables.
                      </li>
                      <li className="flex items-center">
                        <span className="text-amber-500 mr-2">•</span>{" "}
                        Esperanza: Creemos en el poder del cambio y la
                        recuperación.
                      </li>
                    </ul>
                  </div>
